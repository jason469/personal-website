...
export const EmploymentData: Array<employmentData> = [
  ...
  },
  {
    ...
    endDate: "2023",
    description: [
      "Developed four seperate applications across their entire lifecycle",
  ...
  },
  {
    ...
    endDate: "2021",
    description: [
      "Developed one application from inception to Proof of Concept, which involved a lot of R&D and planning, alongside technical development",
  ...
  {
    role: "Production Validation Intern",
    company: "Navico",
    startDate: "2019",
    endDate: "2020",
    description: [
